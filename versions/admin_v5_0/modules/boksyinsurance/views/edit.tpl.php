...
<div class="page">
    ...
    <div class="page-header">
        <h1 class="page-title">Boksy - Ubezpieczenia</h1>
        <ol class="breadcrumb">
            <li><a href="{{$siteUrl}}">Pulpit</a></li>
            <li><a href="{{$siteUrl}}boksyinsurance">Ubezpieczenia</a></li>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <form autocomplete="off" method="POST" enctype="multipart/form-data">
                    ...
                    {{if $postback.type!=="bottom_left" && $postback.type!=="bottom_right" && $postback.type!=="bottom_group"}}
                    <div class="form-group form-material">
